...
export const GlobeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C13.18 7.061 14.287 7.5 15.5 7.5c1.213 0 2.32-.439 3.166-1.136m0-1.414V3m-3.166 1.136L18.75 3.25m-7.5 2.121V3m0 2.121c-1.12 0-2.233.038-3.334.114M6 5.621a48.474 48.474 0 00-3 2.121m0 0A48.474 48.474 0 003 18.75m0 0c-1.12 0-2.233.038-3.334.114M6 18.375a48.474 48.474 0 01-3-2.121m3 2.121V21m0-2.625a48.474 48.474 0 003 2.121m0 0c1.12 0 2.233.038 3.334.114M9 18.375a48.474 48.474 0 003 2.121m3-2.121V21m0-2.625a48.474 48.474 0 013 2.121m0 0c1.12 0 2.233.038 3.334.114M12 18.375a48.474 48.474 0 013 2.121m-3-2.121V21m3.334-2.364C13.18 16.939 14.287 16.5 15.5 16.5c1.213 0 2.32-.439 3.166 1.136m0 1.414V21m-3.166-1.136l2.916 2.063m-7.5-2.121V21" />
  </svg>
);
...
export const GoogleSheetsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2ZM18 20H6V4H13V9H18V20ZM10 18H14V16H10V18ZM10 15H14V13H10V15ZM10 12H14V10H10V12Z" fill="#34A853"/>
    </svg>
);